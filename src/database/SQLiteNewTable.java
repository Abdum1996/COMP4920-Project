...
public class SQLiteNewTable {
	...
	public static void newTable() {
		...
		try {
			...
			String sql = "CREATE TABLE FOOD (ID INT PRIMARY KEY NOT NULL, NAME TEXT NOT NULL, ENERGY FLOAT NOT NULL, PROTEIN FLOAT NOT NULL, FAT FLOAT NOT NULL, SFA FLOAT NUT NULL, CARB FLOAT NOT NULL, SUGAR FLOAT NOT NULL, SODIUM FLOAT NOT NULL, COST FLOAT NOT NULL)";
